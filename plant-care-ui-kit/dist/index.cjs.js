...
, cache) {
  ...
  var serialized = serializeStyles([styles], undefined, React__namespace.useContext(ThemeContext$1));
...
function getReactNodeRef(element) {
  if (!element || ! /*#__PURE__*/React__namespace.isValidElement(element)) {
    return null;
  }
...
var StyledCard = styled$1(Card)(templateObject_1$3 || (templateObject_1$3 = __makeTemplateObject(["\n    width: 250px;\n    height: 300px;\n    border-radius: 16px;\n    text-align: center;\n    box-shadow: 0 6px 16px rgba(0, 0, 0, 0.1);\n    transition: transform 0.3s ease, box-shadow 0.3s ease;\n    cursor: pointer;\n\n    &:hover {\n        transform: translateY(-5px);\n        box-shadow: 0 12px 24px rgba(0, 0, 0, 0.15);\n    }\n"], ["\n    width: 250px;\n    height: 300px;\n    border-radius: 16px;\n    text-align: center;\n    box-shadow: 0 6px 16px rgba(0, 0, 0, 0.1);\n    transition: transform 0.3s ease, box-shadow 0.3s ease;\n    cursor: pointer;\n\n    &:hover {\n        transform: translateY(-5px);\n        box-shadow: 0 12px 24px rgba(0, 0, 0, 0.15);\n    }\n"])));
var PlantCard = function (_a) {
    var name = _a.name, imageUrl = _a.imageUrl;
    return (jsxRuntimeExports.jsxs(StyledCard, { children: [jsxRuntimeExports.jsx(CardMedia, { component: "img", image: imageUrl, alt: name, style: {
                    height: '200px',
                    borderRadius: '50%',
                    margin: '16px auto',
                    width: '80%',
                    objectFit: 'cover',
                    transition: 'transform 0.3s ease, box-shadow 0.3s ease',
                } }), jsxRuntimeExports.jsx(CardContent, { children: jsxRuntimeExports.jsx(Typography, __assign({ variant: "h6", component: "div", style: { fontFamily: 'Poppins', fontWeight: 600 } }, { children: name })) })] }));
};
var templateObject_1$3;

var Button = newStyled.button(templateObject_1$2 || (templateObject_1$2 = __makeTemplateObject(["\n  background-color: #00b894;\n  color: white;\n  border: none;\n  border-radius: 4px;\n  cursor: pointer;\n  padding: ", ";\n  font-size: ", ";\n"], ["\n  background-color: #00b894;\n  color: white;\n  border: none;\n  border-radius: 4px;\n  cursor: pointer;\n  padding: ", ";\n  font-size: ", ";\n"])), function (_a) {
    var size = _a.size;
...
var Grid = newStyled.div(templateObject_1$1 || (templateObject_1$1 = __makeTemplateObject(["\n  display: grid;\n  grid-template-columns: repeat(auto-fill, minmax(200px, 1fr));\n  gap: 40px;\n  padding: 50px;\n  justify-items: center;\n  background-color: #f9fafb;\n"], ["\n  display: grid;\n  grid-template-columns: repeat(auto-fill, minmax(200px, 1fr));\n  gap: 40px;\n  padding: 50px;\n  justify-items: center;\n  background-color: #f9fafb;\n"])));
var templateObject_1$1;

var Text = newStyled.span(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  font-family: 'Poppins', sans-serif;\n  transition: color 0.2s ease, font-size 0.2s ease;\n  color: ", ";\n  font-size: ", ";\n"], ["\n  font-family: 'Poppins', sans-serif;\n  transition: color 0.2s ease, font-size 0.2s ease;\n  color: ", ";\n  font-size: ", ";\n"])), function (_a) {
    var color = _a.color;
    return color || '#333333';
}, function (_a) {
...
function makeStyles(stylesOrCreator, options = {}) {
  ...
  const useStyles = (props = {}) => {
    ...
    const stylesOptions = {
      ...React__namespace.useContext(StylesContext),
      ...stylesOptions2
    };
...
var PlantSearch = function (_a) {
    var query = _a.query, onSearch = _a.onSearch, placeholder = _a.placeholder;
    var classes = useStyles();
    var handleInputChange = function (e) {
        onSearch(e.target.value);
    };
    return (jsxRuntimeExports.jsx(TextField, { className: classes.searchInput, variant: "outlined", value: query, onChange: handleInputChange, placeholder: placeholder || 'Search...', label: placeholder || 'Search...', InputProps: {
            style: { padding: '10px' },
        }, fullWidth: true }));
};
...
exports.PlantSearch = PlantSearch;
exports.Text = Text;
